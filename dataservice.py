...
def retrieve_by_template(table, t, fields=None, limit=None, offset=None, orderBy=None):
    key = data_cache.compute_key(table, t, fields)
    if data_cache.check_query_cache(table, t, fields):
        print("CACHE HIT")
        return data_cache.check_query_cache(table, t, fields)
    print("CACHE MISS")
    if t is not None:
    ...
    data_cache.add_to_query_cache(table, t, fields, r)
    return r
